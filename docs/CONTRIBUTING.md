...
3. **Code Style Standards**:
   - **Frontend**: Follow React 19 functional component standards and TypeScript strict typing.
   - **Styling**: Maintain the signature glassmorphic cyber-minimal dark palette (`#09090b` background, `#ccff00` neon accent).
   - **Backend**: Adhere to standard Rust code formatting (`cargo fmt`) and check for warnings (`cargo clippy`).
...
By contributing to Muziso, you agree that your contributions will be licensed under the project's [MIT License](https://github.com/xtros/Muziso/blob/main/LICENSE).
